    ...
    <div className="flex h-screen">
      ...
      <main className="flex-1 overflow-auto p-8">
        <div className="mx-auto max-w-3xl space-y-6">
          ...
          <Card className="border-zinc-800 bg-zinc-900/50">
            <CardHeader>
              <CardTitle className="text-lg text-zinc-100">GitLab Webhook Setup</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-zinc-400">
                Configure a GitLab webhook to auto-trigger reviews when MRs are opened or updated.
              </p>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    <button
                      onClick={() => navigator.clipboard.writeText(gitlabWebhookUrl)}
                      className="rounded px-3 py-2 text-xs text-zinc-400 hover:text-zinc-200 bg-zinc-800 hover:bg-zinc-700"
                    >
                      Copy
                    </button>
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-300 mt-1">Merge request events</p>
                </div>

                <div className="rounded-lg bg-zinc-950 border border-zinc-800 p-4 text-xs text-zinc-400 space-y-2">
                  <p className="font-medium text-zinc-300">Setup steps:</p>
                  <ol className="list-decimal list-inside space-y-1">
                    <li>Go to your project Settings &rarr; Webhooks</li>
                    <li>Set URL to the URL above</li>
                    <li>Set Secret token to match your GITLAB_WEBHOOK_SECRET env var</li>
                    <li>Check &ldquo;Merge request events&rdquo;</li>
                    <li>Click Add webhook</li>
                  </ol>
                </div>
              </div>
